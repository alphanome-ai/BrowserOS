...
description: "Set up Fouwser in 2 minutes"
---

Welcome to Fouwser! Let's get you set up.
...
<Steps>
  ...
  <Step title="Set up your AI">
    Fouwser lets you add your own AI model.
...
<Columns cols={2}>
  ...
  <Card title="Use with Claude Code" icon="terminal" href="/features/use-with-claude-code">
    Control Fouwser from Claude Code or Gemini CLI
  </Card>
</Columns>
